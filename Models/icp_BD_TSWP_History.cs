...
namespace Test__Connection.Models
{
    ...
    public partial class icp_BD_TSWP_History
    {
        ...
        public Nullable<System.DateTime> Rendate { get; set; }
        public string Operator { get; set; }
        public string Currentinsurer { get; set; }
        public Nullable<int> Renewaloffered_YENO_VTId { get; set; }
        public Nullable<decimal> Crenewalprice { get; set; }
        public string Paymentfreq { get; set; }
        public string Newinsurer { get; set; }
        public Nullable<decimal> Nrenewalprice { get; set; }
